...
/**
 * Public marketing navbar — Home / Features / About / Help / Contact plus
 * Login / Register. This component ONLY ever renders for signed-out
 * visitors now.
 *
 * Once a user is authenticated, ConditionalNavbar (in App.jsx) swaps this
 * out entirely for <DashboardHeader showLogo /> — the same header used on
 * the Jobseeker/Manager/Admin dashboards — so none of the marketing links
 * or Login/Register are ever rendered for a logged-in user, on any page.
 * (Previously this component tried to handle both states itself with a
 * `user` check; that's been removed since it's dead code now that the
 * switch happens one level up.)
 */
function Navbar() {
